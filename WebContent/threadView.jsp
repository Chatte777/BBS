			...
			<table class="table table-striped">
				<tbody>
					...
					<tr>
						...
						%>
						<td align="center"><a onclick="return confirm('정말로 삭제하시겠습니까?')" a href="threadReplyDeleteAction.jsp?bbsID=<%=threadNo%>&replyID=<%=list.get(i).getReplyNo()%>" type="button" class="close" aria-label="close"> <span aria-hidden="true">&times;</span>
						</a></td>
						<%
							}
						%>
