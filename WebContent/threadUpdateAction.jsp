	...
	<%
		...
		if(session.getAttribute("userID") != null){
			...
			if(!userID.equals(threadMaster.getThreadMakeUser())){
				...
				if(request.getParameter("threadTitle") == null || request.getParameter("threadContent")==null
						|| request.getParameter("threadTitle").equals("") || request.getParameter("threadContent").equals("")){
					PrintWriter script = response.getWriter();
					script.println("<script>");
					...
					int result = threadMasterDAO.update(threadNo, request.getParameter("threadTitle"), request.getParameter("threadContent"));
